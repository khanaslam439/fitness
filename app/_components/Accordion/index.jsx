  ...
  return (
    <div className='relative shadow dark:shadow-gray-800 mb-4 rounded-md overflow-hidden'>
        <h2 className="text-base font-semibold mb-0">
            <button type="button" className="flex justify-between items-center p-5 w-full font-medium text-start bg-gray-50 dark:bg-slate-800 text-indigo-600" onClick={e => setActive((prev) => !prev)}>
                <span>{title}</span>
