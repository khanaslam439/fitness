                ...
                <div className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg" style={{minWidth:minWidth, minHeight: minWidth / 3}}>
                    <div className="bg-white px-6 py-6 sm:p-6 sm:pb-4">
                        <div className="flex justify-between items-center mb-6">
                            <h3 className="text-base text-xl mb-0 leading-6 text-indigo-600 text-center" id="modal-title">What type of trainer you want?</h3>
                            <span className="uil uil-times text-2xl text-indigo-500 cursor-pointer" onClick={e => onCloseHander(false)}></span>
                        </div>
                        <div className="">
