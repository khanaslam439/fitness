            ...
            <div className="relative flex w-full" >
                <div className="w-full lg:w-[40%] justify-center lg:h-[100vh] px-6 flex items-center flex-col gap-5">
                    <div className="max-w-[400px] w-full p-6 pb-0 rounded-lg bg-white">
                        <h5 className="mb-1 text-3xl text-indigo-500 font-semibold">Login</h5>
                        <p className="mb-5 text-slate-600">Log into your account</p>
                    ...
                    <div className="text-center">
                        <span className="text-slate-300 me-2 mt-5">Dont have an account? <a href="/register" className="text-white font-semibold inline-block">Register now</a></span>
                    </div>
                </div>
