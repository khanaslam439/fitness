  ...
  return (
    <>
        ...
        <main className='bg-white'>
            <section className="relative table w-full pt-32 pb-0 bg-white">
                ...
                <div className="container">
                    <div className='relative z-10'>
                        <h1 className='text-4xl text-center text-white font-normal mb-5'>Frequently Asked Question</h1>
                        <div className='flex bg-[#fff9] rounded-xl overflow-hidden max-w-[650px] mx-auto'>
                            <i className="uil uil-search text-xl p-3 px-5"></i>
            ...
            <section className='pt-36 pb-20 container'>
                <div className='grid grid-cols-2 gap-5 px-5 border-b border-b-slate-500 pb-8 mb-10'>
                    <div>
                        <h4 className='text-xl font-bold mb-2'>General</h4>
                        <p className='w-[300px] text-xs'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Consectetur repudiandae harum dolore vero.</p>
                    </div>
                    <div>
                ...
                <div className='grid grid-cols-2 gap-5 px-5 border-b border-b-slate-500 pb-8 mb-10'>
                    <div>
                        <h4 className='text-xl font-bold mb-2'>Plans</h4>
                        <p className='w-[300px] text-xs'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Consectetur repudiandae harum dolore vero.</p>
                    </div>
                    <div>
                ...
                <div className='grid grid-cols-2 gap-5 px-5 border-b border-b-slate-500 pb-8 mb-10'>
                    <div>
                        <h4 className='text-xl font-bold mb-2'>Stories</h4>
                        <p className='w-[300px] text-xs'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Consectetur repudiandae harum dolore vero.</p>
                    </div>
                    <div>
                ...
                <div className='grid grid-cols-2 gap-5 px-5'>
                    <div>
                        <h4 className='text-xl font-bold mb-2'>Miscellaneuos</h4>
                        <p className='w-[300px] text-xs'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Consectetur repudiandae harum dolore vero.</p>
                    </div>
                    <div>
                        <Accordion title={'How to reduce Belly Fat?'} description={'Lorem ipsum dolor sit amet consectetur adipisicing elit. Consectetur repudiandae harum dolore, ipsam accusamus possimus incidunt vitae vel vero.'} />
